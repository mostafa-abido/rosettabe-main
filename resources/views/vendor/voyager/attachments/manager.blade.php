    ...
    Vue.component('media-manager-3', {
        ...
        methods: {
            getFiles: function() {
                var vm = this;
                vm.is_loading = true;
                $.post('{{ route('filemanager-attachments.files') }}', { folder: vm.current_folder, _token: '{{ csrf_token() }}', details: vm.details }, function(data) {
                    vm.files = [];
            ...
            renameFile: function(object) {
                ...
                $.post('{{ route('filemanager-attachments.rename') }}', {
            ...
            createFolder: function(e) {
                ...
                $.post('{{ route('filemanager-attachments.new_folder') }}', { new_folder: vm.current_folder+'/'+name, _token: '{{ csrf_token() }}' }, function(data) {
					if(data.success == true){
            ...
            deleteFiles: function() {
                ...
                var vm = this;
                $.post('{{ route('filemanager-attachments.delete') }}', {
            ...
            moveFiles: function(e) {
				...
				$.post('{{ route('filemanager-attachments.move') }}', {
                    path: vm.current_folder,
                    files: vm.selected_files,
            ...
            crop: function(mode) {
				...
				$.post('{{ route('filemanager-attachments.crop') }}', postData, function(data) {
					if (data.success) {
        ...
        mounted: function() {
            ...
            if (this.allowUpload && !dropzone.hasClass('dz-clickable')) {
                dropzone.dropzone({
                    timeout: 180000,
                    url: '{{ route('filemanager-attachments.upload') }}',
