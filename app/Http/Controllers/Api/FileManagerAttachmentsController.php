...
class FileManagerAttachmentsController extends Controller
{
    /** @var string */
    private $filesystem;
    ...
    {
        $this->filesystem = config('voyager.storage.aws-s3-attachments');
    }
    ...
    public function index()
    {
        ...
        return view('vendor.voyager.attachments.index');
    }
