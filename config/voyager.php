...
return [
  ...
  'user' => [
    ...
    'default_role'                 => 'user',
    'default_avatar'               => env('DEFAULT_USER_AVATAR'),
  ...
  /*
    ...
    */
    ...
    'storage' => [
        'disk' => env('FILESYSTEM_DRIVER', 'aws-s3-public'),
        'resources' => env('FILESYSTEM_DRIVER', 'resources'),
        'aws-s3-resources' => env('FILESYSTEM_DRIVER', 'aws-s3-resources'),
        'aws-s3-attachments' => env('FILESYSTEM_DRIVER', 'aws-s3-attachments'),
        's3' => env('FILESYSTEM_DRIVER', 's3')
    ],
